...
<body>
  ...
  <div style="
    ...
    margin-bottom:25px;
  ">
    <h4 style="margin-bottom:10px; color:#0d47a1;">Edit Data Buku</h4>

    <label style="font-weight:600;">Judul buku yang akan diedit:</label><br>
    <input type="text" placeholder="Masukkan judul buku..."
      style="padding:10px; width:260px; margin-top:8px; border-radius:6px; border:1px solid #bbb;">
    <button style="
      padding:10px 18px;
      background:#1976d2;
      border:none;
    ...
    <div style="margin-top:12px;">
      <a href="#" style="color:#1565c0; font-weight:600;">➕ Input buku baru</a>
    </div>
  </div>

  <!-- REPORT BUKU -->
  <div class="content-box" style="padding:20px; width:350px;">
    <h4 style="margin-bottom:15px; color:#0d47a1;">Report Buku</h4>

    <label>Tahun</label><br>
    <select style="padding:8px; width:130px; border-radius:6px; border:1px solid #ccc; margin-top:6px;">
      <option>2025</option>
      <option>2024</option>
      <option>2023</option>
    </select>
    ...
    <select style="padding:8px; width:210px; border-radius:6px; border:1px solid #ccc; margin-top:6px;">
      <option>Karya Mono</option>
    ...
    <p><b>Jumlah Masuk 2025:</b> 499 Buku</p>
    <p><b>Jumlah Sumbangan 2025:</b> 148 Buku</p>
    <p><b>Jumlah Tugas Akhir 2025:</b> 148 Buku</p>
  </div>
</div>
